...
-- 2026-01-06_update_eso_m_c0007_ssym_category.sql
-- 目的：セットシンボルカテゴリマスタ更新
-- 作成日: 2026-01-06
-- 作成者: 浦大輔
-- 対象DB：PostgreSQL
...
--
-- PREPARE update_ssym_category AS
-- UPDATE eso_m_c0007_ssym_category SET category_nm = $4, zumen_kind = $5, order_jn = $6,
--     record_date = now(), record_user = $7
-- WHERE category1_cd = $1 AND category2_cd = $2 AND category3_cd = $3;
--
-- EXECUTE update_ssym_category(1, NULL, NULL, '更新カテゴリ名称', 2, 2, 'user002');

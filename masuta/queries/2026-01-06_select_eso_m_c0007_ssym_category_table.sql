...
-- 2026-01-06_select_eso_m_c0007_ssym_category.sql
-- 目的：セットシンボルカテゴリマスタ取得
-- 作成日: 2026-01-06
-- 作成者: 浦大輔
-- 対象DB：PostgreSQL
...
--
-- PREPARE select_ssym_category AS
-- SELECT ... FROM eso_m_c0007_ssym_category 
-- WHERE category1_cd = $1 AND category2_cd = $2 AND category3_cd = $3;
--
-- EXECUTE select_ssym_category(1, NULL, NULL);
